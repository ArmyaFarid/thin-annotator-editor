...
export const AnnotatorBadge: React.FC = () => {
    ...
    return (
        <button
            ...
            className="fixed top-2 right-2 z-50 flex items-center gap-1.5 bg-secondary/80 border border-white/15 px-2.5 py-1 rounded-full text-xs text-white/70 hover:text-white hover:border-white/30 transition-colors">
